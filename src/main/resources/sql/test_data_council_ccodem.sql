-- ============================================================
-- [폐기 예정] 본 스크립트는 1회성 초기 적재용이며 이미 반영되었습니다.
--   컬럼명 변경(V20260622_005) 이전 스키마 기준입니다:
--     CO_C_ID -> CO_C_ID_NM, STT_DTM(DATE) -> STT_DT(VARCHAR2(8) 'YYYYMMDD'),
--     END_DTM(DATE) -> END_DT(VARCHAR2(8) 'YYYYMMDD').
--   재실행이 필요하면 위 컬럼명/타입에 맞게 수정 후 사용하세요.
-- ============================================================
