 ...
 *
 * <p>세 종류 모두 {@code PK_CONE}가 협의회ID({@code IT_PTL_ASCT_ID})이며,
 * 규칙은 다음 중 하나를 만족하면 읽기 허용이다.</p>
 * <ul>
 *   <li>관리자 또는 정보보안관리자</li>
 *   <li>해당 협의회의 위원(BCMMTM에 사번 존재)</li>
 *   <li>협의회 사업(BPROJM)의 주관부서({@code SVN_DPM_C})가 사용자 부서({@code bbrC})와 동일</li>
 * </ul>
 */
@Component
