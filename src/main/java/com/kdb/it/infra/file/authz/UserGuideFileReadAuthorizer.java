 ...
 *
 * <p>사용자가이드는 헤더에서 전 직원이 내려받는 포털 매뉴얼이므로 인증된 사용자에게 읽기를 허용한다. (default-deny의 명시적 예외)
 *
 * <p>이 선언이 {@link FileKindRegistry}가 종류 {@code 사용자가이드}를 아는 유일한 근거이기도 하다. 판정기를 지우면 업로드 자체가 막힌다.
 */
@Component
