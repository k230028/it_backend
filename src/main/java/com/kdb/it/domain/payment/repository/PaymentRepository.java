 ...
 * 대금지급 마스터 Repository.
 *
 * <p>기본 CRUD는 {@link JpaRepository}가 제공하고, 동적 목록 조회는 {@link PaymentRepositoryCustom}에 위임합니다.
 */
public interface PaymentRepository
        extends JpaRepository<Bpaymm, BpaymmId>, PaymentRepositoryCustom {
     ...
     *
     * <p>중복 신청 방지: stsTc가 "91"(작성중) 또는 "93"(진행중)인 건이 있으면 신규 의뢰 불가.
     *
