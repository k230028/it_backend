 ...
 *
 * <p>마스터(Bpaymm) 1건에 N행의 회차별 지급 명세(Bpaymt)를 관리합니다.
 */
public interface PaymentLineRepository extends JpaRepository<Bpaymt, BpaymtId> {
     ...
     */
    List<Bpaymt> findByDocMngNoAndDocVrsSnoAndDelYn(
            String docMngNo, Integer docVrsSno, String delYn);
}
