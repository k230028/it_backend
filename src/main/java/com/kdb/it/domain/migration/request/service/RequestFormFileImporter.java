 ...
 *
 * <p>정보화사업의 사업 단위 금액은 {@code createProject}가 품목 합계로 한 번 기록한 뒤, 1-1이 금액을 선언한 파일에 한해 {@code
 * assignDeclaredAmounts}로 덮어씁니다. 순서를 뒤집을 수 없습니다 — 채번이 끝나야 사업관리번호가 정해지고, 품목 저장이 끝나야 {@code
