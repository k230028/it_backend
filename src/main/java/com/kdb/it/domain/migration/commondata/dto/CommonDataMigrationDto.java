 ...
 * MethodArgumentNotValidException}(0-기반 인덱스, 첫 위반만 보고)으로 끝나 "메뉴 시트 N행: ..." 형식의 다건 집계 오류 메시지가
 * 무력화된다. 필수값·허용값 검증은 전부 {@code CommonDataMigrationPlanner}가 담당한다.
 */
public final class CommonDataMigrationDto {
    ...
    public record RouteRow(
            int excelRow, String srePth, String sreMnuNm, String useYn, String rmk) {}
