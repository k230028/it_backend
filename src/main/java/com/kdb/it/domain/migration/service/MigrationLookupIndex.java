 ...
 * @param generalExpenseRate 일반관리비(전산업무비) 기본 편성률 — {@code DUP_IOE_MNGC} 공통코드값. 없으면 100
 */
public record MigrationLookupIndex(
        ...
        BigDecimal generalExpenseRate) {

    /**
     * 코드 카탈로그 없이 조직·비목·환율만 담은 인덱스를 만듭니다. 코드 검증을 다루지 않는 단위 테스트가 씁니다. 일반관리비 편성률은 코드가 없을 때의 기본값(100)으로
     * 둡니다.
     *
