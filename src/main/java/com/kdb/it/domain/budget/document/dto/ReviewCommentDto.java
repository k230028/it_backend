 ...
 *
 * <p>문서 검토의견({@link Brivgm})의 생성 요청 및 조회 응답 DTO를 정적 중첩 클래스 형태로 관리합니다.
 */
public class ReviewCommentDto {
     ...
     * 검토의견 생성 요청 DTO
     *
     * <p>{@code ivgTp}가 {@code I}(인라인)인 경우 {@code markId}, {@code qtdCone}을 함께 전달해야 합니다. {@code
     * G}(전반) 코멘트인 경우 두 필드는 {@code null}로 둡니다.
     */
    @Getter
    @NoArgsConstructor
    public static class CreateRequest {
        /** 문서버전 (예: 1.00, 1.01) */
        @NotNull private BigDecimal docVrs;
        ...
        /** 의견내용 (CLOB) */
        @NotBlank private String ivgOpnnCone;
        ...
        public Brivgm toEntity(String docMngNo) {
            ...
            return Brivgm.create(
                    docMngNo,
                    DocVersionCodec.toStored(docVrs),
                    itPtlRplOpnnTc,
                    ivgOpnnCone,
                    markId,
                    qtdCone);
