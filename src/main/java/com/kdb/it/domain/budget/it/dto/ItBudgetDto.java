 ...
 *
 * <p>IT/정보보호 구분 비목별 편성요청액·편성액 집계 및 전년 대비 증감 비교 DTO를 정적 중첩 클래스(Static Nested Class) 형태로 관리합니다.
 */
public class ItBudgetDto {
     ...
     * @param bankCategoryNm 당행 비목명 — 코드값약어명 (CO_CDVA_ABV_NM, 예: 외주용역). 약어명이 없으면 코드값명으로 대체됩니다.
