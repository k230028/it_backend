 ...
 * 문서 검토의견 REST 컨트롤러
 *
 * <p>문서(TPRMPP_BRDOCM) 특정 버전에 달린 검토의견(TPRMPP_BRIVGM)의 조회·등록·해결처리 엔드포인트를 제공합니다.
 *
 * <p>기본 URL: {@code /api/documents/{docMngNo}/review-comments}
 *
 * <p>보안: JWT 토큰 인증 필요
 */
...
public class ReviewCommentController {
                            ...
                            content =
                                    @Content(
                                            schema =
                                                    @Schema(
                                                            implementation =
                                                                    ReviewCommentDto.CreateRequest
                                                                            .class),
                                            examples =
                                                    @ExampleObject(
                                                            name = "인라인 검토의견 등록 예시",
     ...
     * 검토의견 해결 처리
     *
     * <p>지정한 의견일련번호의 FSG_YN 값을 'Y'로 변경합니다.
     *
