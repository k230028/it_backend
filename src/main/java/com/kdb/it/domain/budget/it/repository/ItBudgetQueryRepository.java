 ...
 *
 * <p>IT/정보보호 구분 비목별 편성요청액·편성액 집계 쿼리를 정의합니다. BITEMM + BCOSTM 요청금액과 BBUGTM 편성액을 infPrtYn 기준으로 분리합니다.
 */
public interface ItBudgetQueryRepository {
     ...
     *
     * <p>편성요청액: BITEMM(→BPROJM 연도필터) + BCOSTM, infPrtYn 기준 분리. 편성액: BBUGTM(orcTb='BITEMM'→BITEMM,
     * orcTb='BCOSTM'→BCOSTM), infPrtYn 기준 분리. 금액 단위: 천원 (원 합계 / 1000, TRUNCATE).
     *
