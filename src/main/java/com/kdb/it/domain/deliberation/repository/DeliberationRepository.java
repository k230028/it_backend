 ...
 *
 * <p>기본 CRUD는 {@link JpaRepository}에서 제공하고, 동적 목록 검색은 {@link DeliberationRepositoryCustom}에서
 * QueryDSL로 구현합니다.
 */
public interface DeliberationRepository
        extends JpaRepository<Bdelim, BdelimId>, DeliberationRepositoryCustom {
     ...
     *
     * <p>대상구분(ioeC) + 대상관리번호(cncdRfrNo) + 지정 상태 목록 + 미삭제 조건으로 존재 여부를 확인합니다.
     *
