 ...
 *
 * <p>협의회 1건당 6개 고정 항목 (CCODEM IT_PTL_CKG_ITM_TC 기준)이 관리됩니다.</p>
 */
public interface FeasibilityCheckRepository extends JpaRepository<Bchklc, BchklcId> {
     ...
     */
    List<Bchklc> findByItPtlAsctIdAndDelYn(String itPtlAsctId, String delYn);
     ...
     */
    Optional<Bchklc> findByItPtlAsctIdAndItPtlCkgItmTcAndDelYn(String itPtlAsctId, String itPtlCkgItmTc, String delYn);
}
