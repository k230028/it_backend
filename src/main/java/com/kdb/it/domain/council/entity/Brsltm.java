 ...
 * 협의회 결과서 엔티티
 *
 * <p>DB 테이블: {@code TPRMPP_BRSLTM}
 *
 * <p>BASCTM과 1:1 관계이며, Step 3(결과서 작성/검토/결재) 단계에서 작성됩니다. IT관리자(ITPAD001)가 작성하고, 평가위원이 확인 후 결재가
 * 진행됩니다.
 *
 * <p>결과서는 2페이지 구조:
 *
 * <ul>
 *   <li>1page: 일정공지 내용 (사업명, 심의유형, 일시, 장소, 위원목록)
 *   <li>2page: 평균점수 + 종합의견(SYN_OPNN) + 타당성검토의견(CKG_OPNN)
 * </ul>
 */
