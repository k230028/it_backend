 ...
 * 타당성 자체점검 엔티티
 *
 * <p>DB 테이블: {@code TPRMPP_BCHKLM}
 *
 * <p>타당성검토표 작성 단계(Step 1)에서 소관부서 담당자가 6개 점검항목에 대해 자체 점수(1~5)와 점검의견을 작성합니다. 평가위원 평가({@link Bevalm},
 * BEVALM)와 동일한 점검항목 체계(CKG_ITM_C 01~06)를 쓰되, 위원별(사번 포함)이 아니라 협의회 단위로 항목당 1행만 남깁니다.
 *
 * <p>복합키: ({@code IT_PTL_ASCT_ID}, {@code IT_PTL_CKG_ITM_TC})
 */
