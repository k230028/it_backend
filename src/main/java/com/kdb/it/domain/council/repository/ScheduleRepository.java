 ...
 *
 * <p>평가위원별 가능 일정을 수집하고, IT관리자가 최종 일정을 확정합니다.
 */
public interface ScheduleRepository extends JpaRepository<Bschdm, BschdmId> {
     ...
     *
     * <p>IT관리자가 위원별 응답 현황을 확인할 때 사용합니다.
     *
     ...
     *
     * <p>전원 입력 완료 여부를 확인하여 일정확정 버튼 활성화 조건에 사용합니다. BCMMTM에 있지만 BSCHDM에 응답이 없는 위원 수를 반환합니다.
     *
     * @param itPtlAsctId 협의회ID
     * @return 미응답 위원 수
     */
