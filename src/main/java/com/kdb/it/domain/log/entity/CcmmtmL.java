...
public class CcmmtmL extends BaseLogEntity {
    ...
    @Column(name = "CMMT_SNO",      length = 32, comment = "댓글관리번호") private Long  cmmtMngNo;
    ...
    @Column(name = "CMMT_TGT_SNO",      length = 32, comment = "댓글그룹번호") private Long  cmmtGrpNo;
    ...
    @Column(name = "HRK_CMMT_SNO",  length = 32, comment = "상위댓글관리번호") private Long  hrkCmmtMngNo;
}
