...
public class CblbcmL extends BaseLogEntity {
    ...
    @Column(name = "FL_APG_YN", length = 1, comment = "파일첨부여부")
    private String flApgYn;

    @Column(name = "APG_FL_NBR", comment = "첨부파일수")
    private Integer flNbr;

    @Column(name = "GRP_SQN_SNO", comment = "그룹순서일련번호")
    private Integer nacGrpSqn;

    @Column(name = "NAC_LEV_MNG_SNO", comment = "게시물레벨관리일련번호")
