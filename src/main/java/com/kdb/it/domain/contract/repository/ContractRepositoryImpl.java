...
public class ContractRepositoryImpl implements ContractRepositoryCustom {
     ...
     */
    @Override
    public List<ContractDto.ListItem> search(String stsTc, String ioeC, String cncdRfrNo, String bbrC) {
        ...
        return queryFactory.select(Projections.constructor(ContractDto.ListItem.class,
                        ct.docMngNo, ct.docVrsSno, ct.ioeC, ct.cncdRfrNo, ct.stsTc, ct.cttNm, ct.cttAmt, ct.fstEnrUsid, ct.fstEnrDtm))
                .distinct()
                .from(ct)
    ...
    public Optional<ContractTargetRow> findCurrentWithTargetName(String docNo) {
        ...
        return Optional.of(new ContractTargetRow(row.get(0, Bcontm.class), row.get(1, String.class)));
    }
}
