...
public class AdminLogDto {
    ...
    public record LogTableResponse(String key, String title, String tableName, String entityName) {}

    @Schema(name = "AdminLogDto.LogColumnResponse", description = "로그 컬럼 메타 정보")
    public record LogColumnResponse(
            String field, String columnName, String header, boolean userField, boolean primary) {}
