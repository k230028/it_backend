 ...
 *
 * <p>
 * 비목코드의 자본예산/일반관리비 판별과 중분류 그룹명 해석을 제공합니다.
 * 예산작업(BudgetWorkService), 사업(ProjectService), 정보기술부문 예산 조회(ItBudget)가
 * 동일한 분류 기준을 공유하기 위한 단일 진실 공급원입니다.
 * </p>
 */
public final class IoeCategories {
    ...
    public static final Set<String> CAPITAL_CTPS = Set.of("IOE_DVC", "IOE_HW", "IOE_SW", "IOE_CPIT");
     ...
     *
     * <p>C_TP_DES를 우선 사용하고, 없으면 CDVA_DTL 계층("대분류 - 중분류 - 세부")의
     * 중분류를 사용하며, 그마저 없으면 CDVA_DES로 대체합니다.</p>
     *
