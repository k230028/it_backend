 ...
 * 커스텀 인터페이스입니다. {@link UserRepositoryImpl}에서 QueryDSL로 구현됩니다.</p>
 *
 * <p>사용 패턴: {@link UserRepository}가 이 인터페이스를 상속하므로,
 * {@code userRepository.searchByName("홍길동")}과 같이 직접 사용 가능합니다.</p>
 *
 * <p>Spring Data JPA 커스텀 리포지토리 규칙:</p>
 * <ul>
 *   <li>인터페이스 이름이 자유롭지만, 구현 클래스 이름은 반드시 {@code [인터페이스명]Impl}이어야 함</li>
 *   <li>구현 클래스({@link UserRepositoryImpl})에 {@code @Repository} 어노테이션 불필요</li>
 * </ul>
 */
public interface UserRepositoryCustom {
     ...
     *
     * <p>구현: {@link UserRepositoryImpl#searchByName(String)}</p>
     *
