 ...
 * 자격등급 엔티티
 *
 * <p>DB 테이블: {@code TPRMPP_CAUTHI}
 *
 * <p>시스템에서 정의한 자격등급(권한 그룹)을 관리합니다. 주요 자격등급:
 *
 * <ul>
 *   <li>{@code ITPZZ001}: 일반사용자 - 소속 부서 조회, 본인 작성 수정
 *   <li>{@code ITPZZ002}: 기획통할담당자 - 소속 부서 조회/수정/삭제
 *   <li>{@code ITPAD001}: 시스템관리자 - 전체 조회/수정/삭제, 관리자 메뉴 접근
 * </ul>
 */
@Entity
...
public class CauthI extends BaseEntity {
    ...
    /** 권한ID: 자격등급의 고유 식별자 예: ITPZZ001(일반사용자), ITPZZ002(기획통할담당자), ITPAD001(시스템관리자) */
    @Id
