 ...
 *
 * <p>springdoc-openapi 라이브러리를 사용하여 REST API 명세서를 자동으로 생성합니다.
 *
 * <p>Swagger UI 접근 URL:
 *
 * <ul>
 *   <li>Swagger UI: {@code http://localhost:28080/swagger-ui/index.html}
...
public class SwaggerConfig {
     ...
     *
     * <p>Swagger UI 상단에 표시되는 API 제목, 설명, 버전 정보를 설정하고, JWT 토큰(Bearer Auth)을 전역적으로 사용할 수 있도록 Security
     * 설정을 추가합니다.
     *
