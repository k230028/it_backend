 ...
 *
 * <p>CLOGNH 기반 Brute-force 감지: 10분 내 로그인 실패 5회 초과 시 계정 잠금 검증
 */
...
class LoginAttemptServiceTest {
    ...
    void checkLocked_under5Failures_noException() {
        ...
        assertThatCode(() -> loginAttemptService.checkLocked("E001")).doesNotThrowAnyException();
    }
    ...
    void checkLocked_noHistory_noException() {
        ...
        assertThatCode(() -> loginAttemptService.checkLocked("NEWUSER")).doesNotThrowAnyException();
    }
}
