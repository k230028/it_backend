 ...
 *
 * <p>Gemini AI 프록시 컨트롤러의 HTTP 응답 구조와 인증 동작을 검증합니다.
 *
 * <p>테스트 대상 엔드포인트:
 *
 * <ul>
 *   <li>POST /api/gemini/generate — AI 응답 생성
 * </ul>
 */
...
class GeminiControllerTest {
    ...
    void generate_비인증_401() throws Exception {
        // Arrange
        GeminiDto.Request request = GeminiDto.Request.builder().prompt("접근 테스트").build();
    ...
    void generate_빈prompt_400반환() throws Exception {
        GeminiDto.Request request = GeminiDto.Request.builder().prompt("   ").build();
    ...
    void generate_systemInstruction없음_정상처리() throws Exception {
        ...
        GeminiDto.Request request = GeminiDto.Request.builder().prompt("간단한 질문입니다.").build();
        GeminiDto.Response response =
                GeminiDto.Response.builder()
                        .text("간단한 답변입니다.")
                        .model("gemini-2.0-flash")
