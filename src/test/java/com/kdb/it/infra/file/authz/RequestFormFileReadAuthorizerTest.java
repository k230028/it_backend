...
class RequestFormFileReadAuthorizerTest {
    ...
    void sameProjectDepartment_canRead() {
        ...
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-1", "N"))
    ...
    void costDepartment_canRead() {
        ...
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-2", "N"))
    ...
    void missingMappedProjectLedger_cannotRead() {
        CustomUserDetails user = new CustomUserDetails("E001", List.of("ITPZZ001"), "D01");
        Cappla projectMap = map("BPROJM", "ABUS-1");
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-3", "N"))
                .willReturn(List.of(projectMap));
    ...
    void unsupportedSource_cannotRead() {
        ...
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-5", "N"))
    ...
    void blankSourceTable_cannotRead() {
        ...
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-6", "N"))
    ...
    void blankSourceKey_cannotRead() {
        ...
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-7", "N"))
                .willReturn(List.of(incompleteMap));
    ...
    void missingSourceSerial_cannotRead() {
        ...
        given(applicationMapRepository.findByApfDcmNoAndDelYn("APF-8", "N"))
                .willReturn(List.of(incompleteMap));
