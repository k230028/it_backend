...
class BudgetCardNoteControllerTest {
    ...
    private final BudgetCardNoteService service = org.mockito.Mockito.mock(BudgetCardNoteService.class);
    ...
    void save_관리자권한_서비스응답반환() throws Exception {
        ...
        BudgetCardNoteDto.Response response =
                new BudgetCardNoteDto.Response("ORDINARY", "변경 안내");
