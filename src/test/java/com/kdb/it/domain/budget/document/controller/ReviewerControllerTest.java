 ...
 *
 * <p>사전협의 검토자 목록 API의 인증 상태와 응답 구조를 검증합니다.
 */
...
class ReviewerControllerTest {
    ...
    @MockitoBean private ReviewerService reviewerService;
    ...
    void getReviewers_비인증_401() throws Exception {
        mockMvc.perform(get("/api/reviews/reviewers")).andExpect(status().isUnauthorized());
    }
