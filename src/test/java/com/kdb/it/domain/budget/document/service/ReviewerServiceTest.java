 ...
 *
 * <p>검토자 목록: findByTemCInAndDelYn 1회 활성 사용자 배치 조회, 대표자 결정 규칙(팀장 우선→사번 오름차순), 팀 표시 순서 고정을 검증한다.
 */
...
class ReviewerServiceTest {
    ...
    @InjectMocks private ReviewerService reviewerService;

    private UserRepository.CommitteeUserRow makeUser(
            String eno, String usrNm, String temC, String ptCNm) {
    ...
    void getReviewers_팀장우선() {
        stubUsersByRequestedTeam(
                makeUser("E002", "김과장", "18010", "과장"), makeUser("E009", "박팀장", "18010", "팀장"));
    ...
    void getReviewers_사번오름차순() {
        stubUsersByRequestedTeam(
                makeUser("E005", "이차장", "18010", "차장"), makeUser("E001", "정과장", "18010", "과장"));
