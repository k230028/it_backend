 ...
 *
 * <p>입찰/계약 HTTP 응답 구조와 인증 동작을 검증합니다.
 *
...
class ContractControllerTest {
    ...
    void update_returns200() throws Exception {
        mockMvc.perform(
                        put("/api/project/contracts/CTR-2026-0001")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                        objectMapper.writeValueAsString(
    ...
    void changeStatus_returns200() throws Exception {
        mockMvc.perform(
                        post("/api/project/contracts/CTR-2026-0001/status")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                        objectMapper.writeValueAsString(
    ...
    void saveContract_returns200() throws Exception {
        mockMvc.perform(
                        put("/api/project/contracts/CTR-2026-0001/contract")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(
                                        objectMapper.writeValueAsString(
