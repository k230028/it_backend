...
class CouncilRepositoryQueryTest {
    ...
    void findByDepartment_usesSvnDpmC() throws NoSuchMethodException {
        Method method =
                CouncilRepository.class.getMethod("findByDepartment", String.class, String.class);
    ...
    void findProjectsForCouncilAll_usesExistingColumns() throws NoSuchMethodException {
        Method method =
                CouncilRepository.class.getMethod(
                        "findProjectsForCouncilAll", String.class, String.class);
        Query query = method.getAnnotation(Query.class);
