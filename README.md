...
| 테스트 | JUnit 5, Mockito, AssertJ | - | 175개 테스트 파일 |
...
| 날짜 | 변경 내용 |
|------|----------|
| **2026-07-11** | REVIEW.md 재점검: 실제 소스 통계 재검증(메인 Java 380개, 테스트 175개, @Entity 84개, 컨트롤러 38개), Flyway/캐시/사업집행 4단계 문서 기준 유지, 운영 소스의 빈 catch 추가 발견 없음 |
